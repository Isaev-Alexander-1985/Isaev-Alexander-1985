# Привет, я Александр Исаев! 👋

### 👨‍💻 Data Scientist с инженерным бэкграундом

Я специализируюсь на анализе данных и машинном обучении. Имею опыт в управлении сложными инженерными проектами (более 5 лет).

- 🎓 Выпускник расширенного курса **Data Science в Яндекс Практикум**.
- 🔭 Сейчас работаю над пет-проектами в области ML и деплоем моделей.
